...
func (c *WebSocketClient) ClearLeaving(req *lq.ReqCommon) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.FastTest.clearLeaving", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) VoteGameEnd(req *lq.ReqVoteGameEnd) (resp *lq.ResGameEndVote, err error) {
	respChan := make(chan *lq.ResGameEndVote)
	if err = c.send(".lq.FastTest.voteGameEnd", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) CreateIAPOrder(req *lq.ReqCreateIAPOrder) (resp *lq.ResCreateIAPOrder, err error) {
	respChan := make(chan *lq.ResCreateIAPOrder)
	if err = c.send(".lq.Lobby.createIAPOrder", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) CreatePhoneLoginBind(req *lq.ReqCreatePhoneLoginBind) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.createPhoneLoginBind", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) CreateYostarSDKOrder(req *lq.ReqCreateYostarOrder) (resp *lq.ResCreateYostarOrder, err error) {
	respChan := make(chan *lq.ResCreateYostarOrder)
	if err = c.send(".lq.Lobby.createYostarSDKOrder", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) DressingStatus(req *lq.ReqRoomDressing) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.dressingStatus", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) ExchangeDiamond(req *lq.ReqExchangeCurrency) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.exchangeDiamond", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) FetchAllCommonViews(req *lq.ReqCommon) (resp *lq.ResAllcommonViews, err error) {
	respChan := make(chan *lq.ResAllcommonViews)
	if err = c.send(".lq.Lobby.fetchAllCommonViews", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) FetchCommonViews(req *lq.ReqCommonViews) (resp *lq.ResCommonViews, err error) {
	respChan := make(chan *lq.ResCommonViews)
	if err = c.send(".lq.Lobby.fetchCommonViews", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) FetchPhoneLoginBind(req *lq.ReqCommon) (resp *lq.ResFetchPhoneLoginBind, err error) {
	respChan := make(chan *lq.ResFetchPhoneLoginBind)
	if err = c.send(".lq.Lobby.fetchPhoneLoginBind", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) ReceiveActivityFlipTask(req *lq.ReqReceiveActivityFlipTask) (resp *lq.ResReceiveActivityFlipTask, err error) {
	respChan := make(chan *lq.ResReceiveActivityFlipTask)
	if err = c.send(".lq.Lobby.receiveActivityFlipTask", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) RefreshZHPShop(req *lq.ReqReshZHPShop) (resp *lq.ResRefreshZHPShop, err error) {
...
func (c *WebSocketClient) SaveCommonViews(req *lq.ReqSaveCommonViews) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.saveCommonViews", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) UnbindPhoneNumber(req *lq.ReqUnbindPhoneNumber) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.unbindPhoneNumber", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) UseCommonView(req *lq.ReqUseCommonView) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.useCommonView", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) UserComplain(req *lq.ReqUserComplain) (resp *lq.ResCommon, err error) {
	respChan := make(chan *lq.ResCommon)
	if err = c.send(".lq.Lobby.userComplain", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
...
func (c *WebSocketClient) VerificationIAPOrder(req *lq.ReqVerificationIAPOrder) (resp *lq.ResVerificationIAPOrder, err error) {
	respChan := make(chan *lq.ResVerificationIAPOrder)
	if err = c.send(".lq.Lobby.verificationIAPOrder", req, respChan); err != nil {
		return
	}
	resp = <-respChan
	if resp == nil {
