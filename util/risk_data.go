...
const (
	...
	tileTypeHalfSuji46A                  // 설명
	tileTypeHalfSuji46B                  // 설명
	tileTypeSuji37                       // 5.5
	tileTypeSuji28                       // 3.9
	tileTypeSuji19                       // 1.8
	tileTypeDoubleSuji5                  // 2.2
	tileTypeDoubleSuji46                 // 2.3
	tileTypeYakuHaiLeft3                 // 설명
	tileTypeYakuHaiLeft2                 // 설명
	tileTypeYakuHaiLeft1                 // 설명
	tileTypeOtakazeLeft3                 // 설명
	tileTypeOtakazeLeft2                 // 설명
	tileTypeOtakazeLeft1                 // 설명
)
